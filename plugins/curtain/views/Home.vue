...
const correction = require('../assets/refresh.png')
...
.curtain{
  ...
  .curtain-panel {
    ...
    .pull{
      ...
      width: .66rem;
      height: .66rem;
      background: url("../assets/pull.png") no-repeat 0 0;
  ...
  .curtain-panel-left {
    ...
    background: url("../assets/curtain-horizontal.png") no-repeat left 0;
  ...
  .curtain-panel-right {
    ...
    -webkit-transform: translateX(50%);
    transform: translateX(50%);
    background: url("../assets/curtain-horizontal.png") no-repeat right 0;
    background-size: auto 3.45rem;
    transition: all .2s linear;
  }
  .curtain-panel-top {
    ...
    background: url("../assets/curtain-vertical.png") no-repeat center 0;
...
.control-btn{
  ...
  .sides-open-off {
    background: url('../assets/sides-open-off.png') no-repeat center center;
    background-size: 0.75rem 0.4rem;
  }
  .sides-open-off:active{
    background: #2DA3F6 url('../assets/sides-open-on.png') no-repeat center center;
    background-size: 0.75rem 0.4rem;
  ...
  .sides-close-off {
    background: url('../assets/sides-close-off.png') no-repeat center center;
    background-size: 0.75rem 0.4rem;
  }
  .sides-close-off:active{
    background: #2DA3F6 url('../assets/sides-close-on.png') no-repeat center center;
    background-size: 0.75rem 0.4rem;
    box-shadow: 0 0 0.2rem 0 rgba(45, 163, 246, 0.5);
  }
  .sides-close-on {
  ...
  .down-off {
    background: url('../assets/down-off.png') no-repeat center center;
    background-size: 0.41rem 0.56rem;
  }
  .down-off:active{
    background: #2DA3F6 url('../assets/down-on.png') no-repeat center center;
    background-size: 0.41rem 0.56rem;
    box-shadow: 0 0 0.2rem 0 rgba(45, 163, 246, 0.5);
  }
  .down-on {
  ...
  .up-off {
    background: url('../assets/up-off.png') no-repeat center center;
    background-size: 0.41rem 0.56rem;
  }
  .up-off:active{
    background: #2DA3F6 url('../assets/up-on.png') no-repeat center center;
    background-size: 0.41rem 0.56rem;
    box-shadow: 0 0 0.2rem 0 rgba(45, 163, 246, 0.5);
  }
  .up-on {
  ...
  .sides-left-close-off {
    background: url('../assets/sides-left-close-off.png') no-repeat center center;
    background-size: 0.56rem 0.41rem;
  }
  .sides-left-close-off:active {
    background: #2DA3F6 url('../assets/sides-left-close-on.png') no-repeat center center;
    background-size: 0.56rem 0.41rem;
    box-shadow: 0 0 0.2rem 0 rgba(45, 163, 246, 0.5);
  }
  .sides-left-close-on {
  ...
  .sides-left-open-off {
    background: url('../assets/sides-left-open-off.png') no-repeat center center;
    background-size: 0.56rem 0.41rem;
  }
  .sides-left-open-off:active {
    background: #2DA3F6 url('../assets/sides-left-open-on.png') no-repeat center center;
    background-size: 0.56rem 0.41rem;
    box-shadow: 0 0 0.2rem 0 rgba(45, 163, 246, 0.5);
  }
  .sides-left-open-on {
  ...
  .sides-right-close-off {
    background: url('../assets/sides-right-close-off.png') no-repeat center center;
    background-size: 0.56rem 0.41rem;
  }
  .sides-right-close-off:active{
    background: #2DA3F6 url('../assets/sides-right-close-on.png') no-repeat center center;
    background-size: 0.56rem 0.41rem;
    box-shadow: 0 0 0.2rem 0 rgba(45, 163, 246, 0.5);
  }
  ...
  .sides-right-open-off {
    background: url('../assets/sides-right-open-off.png') no-repeat center center;
    background-size: 0.56rem 0.41rem;
  }
  .sides-right-open-off:active {
    background: #2DA3F6 url('../assets/sides-right-open-on.png') no-repeat center center;
    background-size: 0.56rem 0.41rem;
    box-shadow: 0 0 0.2rem 0 rgba(45, 163, 246, 0.5);
  }
  .sides-right-open-on {
  ...
  .play-off {
    background: url('../assets/play-off.png') no-repeat center center;
    background-size: 0.31rem 0.4rem;
  }
  .play-off:active{
    background: #2DA3F6 url('../assets/play-on.png') no-repeat center center;
    background-size: 0.31rem 0.4rem;
    box-shadow: 0 0 0.2rem 0 rgba(45, 163, 246, 0.5);
  }
  .play-on {
