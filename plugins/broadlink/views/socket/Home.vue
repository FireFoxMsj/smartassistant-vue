  ...
  <div class="home">
    ...
    <div class="device">
      <div class="device-pic">
        <div
          class="device-img" :class="{ 'device-img--on': isOn }"></div>
  ...
  methods: {
    ...
    handleMessage(data) {
      ...
      if (msgJson.id === this.stateId) {
        ...
        const switchs = instances.find(item => item.type === 'switch')
        const { attributes } = switchs
        this.instanceId = switchs.instance_id
