<template>
  <div class="home">
    ...
    <div v-if="!hasColor" class="device">
      <template>
        <img v-if="lightType === 'LIFX Mini White'" src="../../assets/light/LIFX-white.png">
        <img v-else-if="lightType === 'LIFX Mini White to Warm'" src="../../assets/light/LIFX-warm.png">
        <img v-else-if="lightType === 'LIFX Color'" src="../../assets/light/linght-color-on.png">
...
export default {
  ...
  data() {
    return {
      ...
      lastTime: null,
      lightType: 'LIFX To White', // ceiling17: 吸顶灯 lamp9: 台灯
      isFleshing: false,
      clientWidth: 0,
    }
  },
  ...
  created() {
    ...
    this.lightType = query.model || 'LIFX To White'
    if (query.name) {
