<template>
  <div class="home">
    ...
    <div v-if="!hasColor" class="device">
      <template>
        <img v-if="lightType === 'color8'" src="../../assets/light/linght-color-on.png">
        <img v-if="lightType === 'Hue white Lamp'" src="../../assets/light/hue-white-lamp.png">
